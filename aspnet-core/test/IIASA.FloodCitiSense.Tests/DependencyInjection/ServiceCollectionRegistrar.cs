...
namespace IIASA.FloodCitiSense.Tests.DependencyInjection
{
    public static class ServiceCollectionRegistrar
    {
        public static void Register(IIocManager iocManager)
        {
            ...
            iocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<FloodCitiSenseDbContext>>()
                    .Instance(builder.Options)
                    .LifestyleSingleton()
            );

            inMemorySqlite.Open();
            new FloodCitiSenseDbContext(builder.Options).Database.EnsureCreated();
        }
