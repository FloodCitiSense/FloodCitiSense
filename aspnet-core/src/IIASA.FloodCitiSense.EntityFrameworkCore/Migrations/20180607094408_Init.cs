    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_creative_entity", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "IncidentApprovals",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IncidentApprovals", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    AnySignOfDamage = table.Column<bool>(nullable: false),
                    AnySignOfObstruction = table.Column<bool>(nullable: false),
                    AreYouImpacted = table.Column<bool>(nullable: false),
                    CreationTime = table.Column<DateTime>(nullable: false),
                    CreatorUserId = table.Column<long>(nullable: true),
                    DeleterUserId = table.Column<long>(nullable: true),
                    DeletionTime = table.Column<DateTime>(nullable: true),
                    ExtensionData = table.Column<string>(nullable: true),
                    FloodDepth = table.Column<int>(nullable: false),
                    FloodExtent = table.Column<int>(nullable: false),
                    FrequencyOfFlood = table.Column<int>(nullable: false),
                    IsDeleted = table.Column<bool>(nullable: false),
                    LastModificationTime = table.Column<DateTime>(nullable: true),
                    LastModifierUserId = table.Column<long>(nullable: true),
                    TenantId = table.Column<int>(nullable: true),
                    TimeCreated = table.Column<DateTime>(nullable: false),
                    TypeOfFlooding = table.Column<int>(nullable: false),
                    TypeOfRain = table.Column<int>(nullable: false),
                    TypesOfSpaceFlooded = table.Column<int>(nullable: false),
                    WaterClarity = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Locations_IncidentId",
                table: "Locations",
                column: "IncidentId");

            migrationBuilder.CreateIndex(
                name: "IX_Pictures_IncidentId",
                table: "Pictures",
                column: "IncidentId");
        }
