...
using IIASA.FloodCitiSense.EntityFrameworkCore.Repositories;

namespace IIASA.FloodCitiSense.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : FloodCitiSenseRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<FloodCitiSenseDbContext> dbContextProvider)
