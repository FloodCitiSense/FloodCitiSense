...
namespace IIASA.FloodCitiSense.ApiClient
{
    public class AbpApiClient : ISingletonDependency, IDisposable
    {
        ...
        public AbpApiClient(IApplicationContext applicationContext)
        {
            _applicationContext = applicationContext;

            //if (_applicationContext.AppInformation == null)
            //{
            //    throw new UnauthorizedAccessException();
            //}
        }

        internal async Task<T> GetAnonymousAsync<T>(string endpoint, object input)
        {
            return await GetAsync<T>(endpoint, input, null, true);
        }
        ...
        {
            return await PostAsync<T>(endpoint, null, null, await _applicationContext.AppInformation.GetAccessTokenAsync(), true);
        }
        ...
        {
            return await PostAsync<T>(endpoint, inputDto, null, await _applicationContext.AppInformation.GetAccessTokenAsync(), true);
        }

        public async Task<T> PostAsync<T>(string endpoint, object inputDto, object queryParameters)
        {
            return await PostAsync<T>(endpoint, inputDto, queryParameters, await _applicationContext.AppInformation.GetAccessTokenAsync(), true);
        }
        ...
        /// <returns></returns>
        public async Task<T> PostAnonymousAsync<T>(string endpoint, object inputDto, bool skipAjax = true)
        {
            return await PostAsync<T>(endpoint, inputDto, null, null, skipAjax);
        }
        ...
        {
            var httpResponse = GetClient(await _applicationContext.AppInformation.GetAccessTokenAsync())
                    .Request(endpoint)
        ...
        public async Task<T> PostMultipartAsync<T>(string endpoint, List<string> filePath, bool stripAjaxResponseWrapper = true)
        {
            var httpResponse = GetClient(await _applicationContext.AppInformation.GetAccessTokenAsync())
                .Request(endpoint)
                .PostMultipartAsync(multiPartContent =>
                {
                    ...
                    {
                        multiPartContent.AddFile("files", file);
                    }
        ...
        {
            await PostAsync(endpoint, null, null, await _applicationContext.AppInformation.GetAccessTokenAsync(), true);
        }

        public async Task PostAsync(string endpoint, object inputDto)
        {
            await PostAsync(endpoint, inputDto, null, await _applicationContext.AppInformation.GetAccessTokenAsync(), true);
        }
        ...
        {
            await PostAsync(endpoint, inputDto, queryParameters, await _applicationContext.AppInformation.GetAccessTokenAsync(), true);
        }
        ...
        {
            return await GetAsync<T>(endpoint, queryParameters, await _applicationContext?.AppInformation?.GetAccessTokenAsync(), true);
        }
        ...
        public async Task<T> GetAsync<T>(string endpoint, object queryParameters, string accessToken, bool stripAjaxResponseWrapper)
        {
            ...
            if (stripAjaxResponseWrapper)
            {
                try
                {
                    if (!Barrel.Current.IsExpired(httpResponse.Url.ToString()))
                    {
                        var res = Barrel.Current.Get<AjaxResponse<T>>(httpResponse.Url.ToString());
                        return res.Result;
                    }
                    ...
                    if (response.Success)
                    {
                        Barrel.Current.Add(httpResponse.Url.ToString(), response, TimeSpan.FromHours(1));
                    }
                    return response.Result;
                }
                catch (System.Exception e)
        ...
        {
            await GetAsync(endpoint, queryParameters, await _applicationContext.AppInformation.GetAccessTokenAsync(), true);
        }
        ...
        {
            await GetStringAsync(endpoint, queryParameters, await _applicationContext.AppInformation.GetAccessTokenAsync());
        }
        ...
        {
            await DeleteAsync(endpoint, null, await _applicationContext.AppInformation.GetAccessTokenAsync());
        }

        public async Task DeleteAsync(string endpoint, object queryParameters)
        {
            await DeleteAsync(endpoint, queryParameters, await _applicationContext.AppInformation.GetAccessTokenAsync());
        }
        ...
        {
            return await DeleteAsync<T>(endpoint, queryParameters, await _applicationContext.AppInformation.GetAccessTokenAsync(), true);
        }
        ...
        {
            return await PutAsync<T>(endpoint, null, null, await _applicationContext.AppInformation.GetAccessTokenAsync(), true);
        }

        public async Task<T> PutAsync<T>(string endpoint, object inputDto)
        {
            return await PutAsync<T>(endpoint, inputDto, null, await _applicationContext.AppInformation.GetAccessTokenAsync(), true);
        }

        public async Task<T> PutAsync<T>(string endpoint, object inputDto, object queryParameters)
        {
            return await PutAsync<T>(endpoint, inputDto, queryParameters, await _applicationContext.AppInformation.GetAccessTokenAsync(), true);
        }
        ...
        {
            await PutAsync(endpoint, null, null, await _applicationContext.AppInformation.GetAccessTokenAsync(), true);
        }

        public async Task PutAsync(string endpoint, object inputDto)
        {
            await PutAsync(endpoint, inputDto, null, await _applicationContext.AppInformation.GetAccessTokenAsync(), true);
        }

        public async Task PutAsync(string endpoint, object inputDto, object queryParameters)
        {
            await PutAsync(endpoint, inputDto, queryParameters, await _applicationContext.AppInformation.GetAccessTokenAsync(), true);
        }
        ...
        private void AddHeaders(string accessToken)
        {
            ...
            _client.WithHeader("Abp.TenantId", "1");
