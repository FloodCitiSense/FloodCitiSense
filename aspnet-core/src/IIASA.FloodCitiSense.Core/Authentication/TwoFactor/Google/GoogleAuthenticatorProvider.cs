...
namespace IIASA.FloodCitiSense.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : FloodCitiSenseServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("IIASA.FloodCitiSense", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
