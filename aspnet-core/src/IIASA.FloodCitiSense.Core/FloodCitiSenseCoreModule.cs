...
namespace IIASA.FloodCitiSense
{
    ...
    public class FloodCitiSenseCoreModule : AbpModule
    {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FloodCitiSenseCoreModule).GetAssembly());
        }
