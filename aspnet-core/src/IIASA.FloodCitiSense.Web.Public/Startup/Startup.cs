...
namespace IIASA.FloodCitiSense.Web.Public.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<FloodCitiSenseWebFrontEndModule>(options =>
            {
...
//Integrate to OWIN
        ...
        private static void ConfigureOwinServices(IAppBuilder app)
        {
            ...
            //Enable it to use HangFire dashboard (uncomment only if it's enabled in FloodCitiSenseWebCoreModule)
