...
using IIASA.FloodCitiSense.Web.Public.Startup;
using IIASA.FloodCitiSense.Web.Session;

namespace IIASA.FloodCitiSense.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : FloodCitiSenseViewComponent
    {
