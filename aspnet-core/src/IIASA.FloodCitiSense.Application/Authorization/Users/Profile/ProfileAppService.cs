...
using IIASA.FloodCitiSense.Authorization.Users.Profile.Cache;
...
using IIASA.FloodCitiSense.Timing;

namespace IIASA.FloodCitiSense.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : FloodCitiSenseAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("IIASA.FloodCitiSense",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("IIASA.FloodCitiSense",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
