...
using IIASA.FloodCitiSense.Authorization.Permissions;
...
using IIASA.FloodCitiSense.Authorization.Users.Exporting;
...
namespace IIASA.FloodCitiSense.Authorization.Users
{
    ...
    public class UserAppService : FloodCitiSenseAppServiceBase, IUserAppService
    {
