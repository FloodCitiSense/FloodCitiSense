...
namespace IIASA.FloodCitiSense.MultiTenancy
{
    ...
    public class TenantAppService : FloodCitiSenseAppServiceBase, ITenantAppService
    {
        ...
        {
            return await TenantManager.Tenants.Select(x => new AllTenantDto{ Id = x.Id, Name = x.Name }).ToListAsync();
        }
