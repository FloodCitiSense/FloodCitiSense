...
using IIASA.FloodCitiSense.Web.Models.TokenAuth;
using IIASA.FloodCitiSense.Authorization.Impersonation;
...
namespace IIASA.FloodCitiSense.Web.Controllers
{
    ...
    public class TokenAuthController : FloodCitiSenseControllerBase
    {
        ...
        private readonly IdentityServerTokenGeneratorFacade _identityServerTokenGeneratorFacade;
